...
class Order(models.Model):
    ...
    address_line2 = models.CharField(max_length=70, null=True, blank=True)
    ...
    def update_total(self):
        ...
        if self.order_total < settings.SHIPPING_FEE_THRESHOLD:
            self.delivery_cost = (
...
class OrderLineItem(models.Model):
    """
    Information on individual item relating to a specific order
    """
